...
public class RendererBattleAxe implements IItemRenderer {
	private IModelCustom modelObj;
	
	ResourceLocation Location = new ResourceLocation("crimson_warfare" + ":" + "textures/models/CrimsonBattleAxe.png");
    
	public RendererBattleAxe() {
		modelObj = AdvancedModelLoader.loadModel(new ResourceLocation(References.MOD_ID +":" +"models/ModelCrimsonBattleaxeTri.obj"));
	}
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object ... data)
    {
    	switch(type)
    	{
    		case EQUIPPED: {
    			float Scale = 1.4f;
    			GL11.glTranslatef(1.5F, -0.65F, -0.1F);
        	...
        	case EQUIPPED_FIRST_PERSON: {
    			...
    			GL11.glTranslatef(0.55F, -1.1F, -0.0F);
    			GL11.glScalef(Scale, Scale, Scale);
    			GL11.glRotatef(0F, 1.0F, 0.0F, 0.0F);
    		...
    		case INVENTORY:{
    			float Scale = 1.2f;
    			GL11.glTranslatef(-1F, -1.5F, 0.3F);
    			GL11.glScalef(Scale, Scale, Scale);
    		...
    		case ENTITY:{
    			float Scale = 1.7f;
    			GL11.glTranslatef(-0.08F, -1F, 0.11F);
    			GL11.glScalef(Scale, Scale, Scale);
    			GL11.glRotatef(0F, 1.0F, 0.0F, 0.0F);
