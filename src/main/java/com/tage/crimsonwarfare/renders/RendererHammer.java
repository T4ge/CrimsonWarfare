...
public class RendererHammer implements IItemRenderer {
	private IModelCustom modelObj;
	
	ResourceLocation Location = new ResourceLocation("crimson_warfare" + ":" + "textures/models/CrimsonHammer.png");
    
	public RendererHammer() {
		modelObj = AdvancedModelLoader.loadModel(new ResourceLocation(References.MOD_ID +":" +"models/ModelCrimsonHammerTri.obj"));
	}
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object ... data)
    {
    	switch(type)
    	{
    		case EQUIPPED: {
    			float Scale = 0.7f;
    			GL11.glTranslatef(1.5F, -0.65F, -0F);
        	...
        	case EQUIPPED_FIRST_PERSON: {
        		float Scale = 0.7f;
    			GL11.glTranslatef(0.55F, -1.1F, 0.1F);
    			GL11.glScalef(Scale, Scale, Scale);
    			GL11.glRotatef(0F, 1.0F, 0.0F, 0.0F);
    			GL11.glRotatef(90F, 0.0F, 1.0F, 0.0F);
    		...
    		case INVENTORY:{
    			float Scale = 0.58f;
    			GL11.glTranslatef(-1.1F, -1.55F, 0.3F);
    			GL11.glScalef(Scale, Scale, Scale);
