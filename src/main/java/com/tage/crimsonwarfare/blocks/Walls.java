...
public class Walls extends BlockWall {
	
	private final String Name = BlockNames.WALLS;
	private IIcon[] Icons;
	...
	{
		switch (meta) {
		case 0: return /*Icons[0];*/ side == 0 ? this.Stone0 : (side == 1 ? this.Stone0 : this.Stone1);
		case 1: return this.Quartz;
		case 2: return this.Brick;
		case 3: return /*Icons[0];*/ side == 0 ? this.SandS0 : (side == 1 ? this.SandS1 : this.SandS2);
