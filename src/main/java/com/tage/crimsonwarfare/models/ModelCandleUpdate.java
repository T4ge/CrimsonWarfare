 ...
 */
public class ModelCandleUpdate extends ModelBase {
    ...
    public ModelCandleUpdate() {
        ...
        this.Flame4.setRotationPoint(1.5F, -2.5F, 1.45F);
        ...
        this.Flame1 = new ModelRenderer(this, 0, 20);
        this.Flame1.setRotationPoint(2.55F, -2.5F, 1.53F);
        ...
        this.Flame3 = new ModelRenderer(this, 0, 20);
        this.Flame3.setRotationPoint(1.45F, -2.5F, 1.53F);
        this.Flame3.addBox(0.0F, 0.0F, 0.0F, 0, 8, 4, 0.0F);
        this.shape10 = new ModelRenderer(this, 0, 9);
        this.shape10.setRotationPoint(1.5F, -1.6F, 1.5F);
    ...
    public void renderflame(float f, float f1, float f2, float f3, float f4, float f5) 
    {
        ...
        GL11.glScaled(1.0D, 0.25D, 0.25D);
        GL11.glTranslatef(-this.Flame3.offsetX, -this.Flame3.offsetY, -this.Flame3.offsetZ);
        GL11.glTranslatef(-this.Flame3.rotationPointX * f5, -this.Flame3.rotationPointY * f5, -this.Flame3.rotationPointZ * f5);
