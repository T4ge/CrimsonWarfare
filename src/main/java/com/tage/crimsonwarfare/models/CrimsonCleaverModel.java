 ...
 */
public class CrimsonCleaverModel extends ModelBase {
    ...
    public CrimsonCleaverModel() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.shape21_5 = new ModelRenderer(this, 0, 0);
        this.shape21_5.setRotationPoint(-0.7F, 21.0F, 0.3F);
        this.shape21_5.addBox(0.0F, 0.0F, -0.3F, 1, 4, 0, 0.0F);
        this.shape11 = new ModelRenderer(this, 25, 2);
        ...
        this.shape15b = new ModelRenderer(this, 16, 3);
        ...
        this.shape4a = new ModelRenderer(this, 30, 0);
        ...
        this.shape8b = new ModelRenderer(this, 52, 0);
        ...
        this.shape21_8.setRotationPoint(1.2F, -1.7F, 0.0F);
        this.shape21_8.addBox(-0.2F, 0.0F, 0.0F, 1, 2, 0, 0.0F);
        this.setRotateAngle(shape21_8, 0.0F, 0.0F, 0.019198621771937624F);
        this.shape12 = new ModelRenderer(this, 31, 2);
        ...
        this.shape15d = new ModelRenderer(this, 39, 4);
        ...
        this.shape21_6.setRotationPoint(2.1F, -2.0F, 0.0F);
        this.shape21_6.addBox(-0.1F, 0.0F, 0.0F, 1, 5, 0, 0.0F);
        this.setRotateAngle(shape21_6, 0.0F, 0.0F, 0.019198621771937624F);
        this.shape21_7 = new ModelRenderer(this, 0, 0);
        this.shape21_7.setRotationPoint(-0.9F, 3.6F, 0.3F);
        this.shape21_7.addBox(0.0F, 0.0F, -0.3F, 1, 15, 0, 0.0F);
        this.shape21_4 = new ModelRenderer(this, 0, 0);
        this.shape21_4.setRotationPoint(1.2F, -1.7F, 0.0F);
        this.shape21_4.addBox(-0.2F, 0.0F, 0.0F, 1, 2, 0, 0.0F);
        this.setRotateAngle(shape21_4, 0.0F, 0.0F, 0.019198621771937624F);
        this.shape15 = new ModelRenderer(this, 39, 2);
        ...
        this.shape14c = new ModelRenderer(this, 17, 6);
        ...
        this.shape21_1 = new ModelRenderer(this, 60, 0);
        this.shape21_1.setRotationPoint(-0.7F, 21.0F, 0.3F);
        this.shape21_1.addBox(0.0F, 0.0F, -0.3F, 1, 4, 0, 0.0F);
        ...
        this.shape21a = new ModelRenderer(this, 0, 0);
        this.shape21a.setRotationPoint(0.1F, -26.0F, 0.8F);
        this.shape21a.addBox(0.0F, 0.0F, 0.0F, 2, 25, 0, 0.0F);
        ...
        this.shape1 = new ModelRenderer(this, 5, 7);
        ...
        this.shape21_2 = new ModelRenderer(this, 60, 0);
        this.shape21_2.setRotationPoint(2.1F, -2.0F, 0.0F);
        this.shape21_2.addBox(-0.1F, 0.0F, 0.0F, 1, 5, 0, 0.0F);
        this.setRotateAngle(shape21_2, 0.0F, 0.0F, 0.019198621771937624F);
        this.shape4d = new ModelRenderer(this, 24, 0);
        ...
        this.shape26 = new ModelRenderer(this, 10, 0);
        ...
        this.shape4c = new ModelRenderer(this, 42, 0);
        ...
        this.shape14b = new ModelRenderer(this, 4, 5);
        ...
        this.shape21_3 = new ModelRenderer(this, 62, 0);
        this.shape21_3.setRotationPoint(-0.9F, 3.6F, 0.3F);
        this.shape21_3.addBox(0.0F, 0.0F, -0.3F, 1, 15, 0, 0.0F);
        this.shape10 = new ModelRenderer(this, 56, 0);
        this.shape10.setRotationPoint(-1.5F, -4.0F, 0.0F);
        this.shape10.addBox(0.0F, 0.0F, 0.0F, 1, 3, 1, 0.0F);
        this.shape14 = new ModelRenderer(this, 4, 3);
        ...
        this.shape4b = new ModelRenderer(this, 36, 0);
        ...
        this.shape15c = new ModelRenderer(this, 23, 4);
        ...
        this.shape21a.addChild(this.shape21_5);
        this.shape21a.addChild(this.shape21_8);
        this.shape21a.addChild(this.shape21_6);
        this.shape21a.addChild(this.shape21_7);
