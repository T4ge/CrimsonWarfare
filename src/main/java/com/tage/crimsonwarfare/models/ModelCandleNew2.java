 ...
 */
public class ModelCandleNew2 extends ModelBase {
    ...
    public ModelCandleNew2() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.shape17 = new ModelRenderer(this, 12, 15);
        this.shape17.setRotationPoint(4.0F, 6.0F, -1.0F);
        this.shape17.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        this.Flame4 = new ModelRenderer(this, 0, 0);
        this.Flame4.setRotationPoint(1.5F, -2.5F, 1.5F);
        this.Flame4.addBox(0.0F, 0.0F, 0.0F, 8, 16, 0, 0.0F);
        this.setRotateAngle(Flame4, -0.008726646259971648F, 0.0F, 0.0F);
        this.Banner = new ModelRenderer(this, 16, 14);
        ...
        this.Flame3 = new ModelRenderer(this, 0, 0);
        this.Flame3.setRotationPoint(1.5F, -2.5F, 1.53F);
        this.Flame3.addBox(0.0F, 0.0F, 0.0F, 0, 16, 8, 0.0F);
        this.setRotateAngle(Flame3, 0.0F, 0.0F, 0.008726646259971648F);
        ...
        this.shape14 = new ModelRenderer(this, 0, 15);
        ...
        this.Flame1.addBox(0.0F, 0.0F, 0.0F, 0, 16, 8, 0.0F);
        this.setRotateAngle(Flame1, 0.0F, 0.0F, -0.008726646259971648F);
        this.shape16 = new ModelRenderer(this, 8, 15);
        this.shape16.setRotationPoint(4.0F, 6.0F, 4.0F);
        this.shape16.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, 0.0F);
        this.shape15 = new ModelRenderer(this, 4, 15);
        ...
        this.Flame2.setRotationPoint(1.5F, -2.5F, 2.5F);
        this.Flame2.addBox(0.0F, 0.0F, 0.0F, 8, 16, 0, 0.0F);
        this.setRotateAngle(Flame2, 0.008726646259971648F, 0.0F, 0.0F);
